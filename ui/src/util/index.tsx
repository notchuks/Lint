 ...
 */
export function diffBetweenCurrentTime(updatedAt: string) {
  const timestamp = updatedAt ? new Date(updatedAt) : 0;
...
//   return formatDistance(parse(timestamp, 'yyyy-MM-dd HH:mm:ss', new Date()), new Date(), {
//     addSuffix: true,
//     includeSeconds: true,
//   }).replace(/^(about|less than)\s/i, '');
// }
